...
public class HeaderFooter extends PdfPageEventHelper{
	...
	public void onStartPage(PdfWriter writer, Document document) {
		...
		try
		{
		image = Image.getInstance(ResourceUtils.getFile("classpath:images/Header.jpg").getAbsolutePath());
//			image = Image.getInstance(ResourceUtils.getFile("images/Header.jpg").getAbsolutePath());
			...
			image.setAbsolutePosition(0, document.getPageSize().getHeight()	+ document.topMargin() - image.getHeight()-9);
//			image.setAbsolutePosition(0, document.getPageSize().getHeight()	+ document.topMargin() - image.getHeight()+30);
			document.add(image);
	...
	public void onEndPage(PdfWriter writer, Document document) {
		...
		fontStyle.setSize(8);
		try {
			image = Image.getInstance(ResourceUtils.getFile("classpath:images/footer.jpg").getAbsolutePath());
