...
public class DefaultJob extends QuartzJobBean {
	private static Logger log = LoggerFactory.getLogger(DefaultJob.class);
	...
	protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
		log.info("update default job started", applicationContext.getBean(Environment.class));

		notificationJob = applicationContext.getBean(NotificationJob.class);

		notificationJob.setPendingToDefault();
	}
